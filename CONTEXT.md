...
Current 2026-08-12 status supersedes the preceding historical closeout wording: the owner-operated packaged review exposed trust-focus, readiness-feedback, and interrupted-classification defects, and the owner authorized a bounded matching-surface repair amendment. R3-B closeout is reopened only for that repair; R3-C remains not started, and R3-D, another provider call, package publication, and release remain unauthorized.
...
- R3-A is owner-accepted and closed. The deterministic and copied packaged TUI rows are green, and the matching real-provider row passed at exact candidate `468c4ba0f726715c2f190b3c2842f798992e8543` under normal TLS. The accepted R3-B Freeze packet is ADR 0020 plus `docs/plans/2026-08-11-r3-b-terminal-product-shell.md`; fresh copied-package evidence is bound to final source `f98e8b3d87b530d46aa7e33664290a02a75ad1a5`, and R3-B is owner-accepted and closed. R3-C remains not started. The accepted production claim remains R2 until a later release gate; another provider/network attempt, package publication, and release remain separately gated.
